...
export default class PostPreview extends React.Component {
  render() {
    ...
    return <div className="massiveCojones">
        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="flex-ns mhn2-ns mb3">
              {(entry.getIn(["data", "massages"]) || []).map((product, i) => <div className="ph2-ns w-50-ns" key={i}>
                <img src={getAsset(product.get("image"))} alt="" className="center db mb3" style={{width: "500px"; height: "375px" ; object-fit: cover;}}/>
                <p>{product.get("text")}</p>
              </div>)}
            </div>

            <div className="tc">
              <a href="#" className="btn raise">{entry.getIn(["data", "massagescta", "btntext"])}</a>
            </div>
          </div>
        </div>
